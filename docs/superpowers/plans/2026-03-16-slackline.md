...
func TestResolveChannel_RawID(t *testing.T) {
	...
	tests := []struct {
		...
		{"C01OPS12345", "C01OPS12345"},
		{"G0A2GP2FRRC", "G0A2GP2FRRC"},
		{"D01DIRECTMSG", "D01DIRECTMSG"},
	}
	for _, tt := range tests {
...
func TestResolveChannel_URL(t *testing.T) {
	...
	tests := []struct {
		...
		{"https://myteam.slack.com/archives/C01OPS12345", "C01OPS12345"},
		{"https://app.slack.com/client/T012AB3CD45/C01OPS12345", "C01OPS12345"},
		{"https://myteam.slack.com/archives/C01OPS12345/p1769756026624319", "C01OPS12345"},
	}
	for _, tt := range tests {
		got, err := r.Resolve(tt.input)
		if err != nil {
...
func TestResolveChannel_Name(t *testing.T) {
	api := &fakeAPI{
		channels: []goslack.Channel{
			{GroupConversation: goslack.GroupConversation{
				Name: "ops", Conversation: goslack.Conversation{ID: "C01OPS12345"},
			}},
			{GroupConversation: goslack.GroupConversation{
				Name: "general", Conversation: goslack.Conversation{ID: "C01GENERAL12"},
			}},
		},
	}
	r := NewResolver(api)
	...
	if got != "C01OPS12345" {
		t.Errorf("Resolve(#ops) = %q, want C01OPS12345", got)
	}
}
...
// Accepts: "#channel-name", "C01OPS12345", or a Slack URL.
...
func (r *Resolver) resolveURL(rawURL string) (string, error) {
	...
	// URL patterns:
	// /archives/C01OPS12345
	// /archives/C01OPS12345/p1769756026624319
	// /client/T.../C01OPS12345
...
func TestMentionEvent_JSON(t *testing.T) {
	e := Event{
		...
		Channel:  "C01OPS12345",
		User:     "U0123",
		Text:     "hey @my-bot check the logs",
	...
	if got["channel"] != "C01OPS12345" {
		t.Errorf("channel = %v, want C01OPS12345", got["channel"])
	}
