...
**Per-bot creation:**
```
$ slackline create --name "drew-claude" --workspace "Prime Radiant"
...
**Output:**
```json
{"ok":true,"channel":"C0A8LJZQSAX","ts":"1769756026.624319"}
```
...
- `https://team.slack.com/archives/C0A8LJZQSAX` → ID extracted from URL
